...
<div>
	<div class="views_counter_settings_left">
		...
		<?php 
			...
			echo elgg_view('input/radio',array('internalname'=>'params[float_direction]','options'=>$options, 'value'=>$value));
		?>
	</div>
	...
	<div class="views_counter_settings_right">
		...
		<?php 
			...
			echo elgg_view('input/radio',array('internalname'=>'params[display_views_counter]','options'=>$options, 'value'=>$value));
		?>
		<br />
		...
		<?php
			...
			echo elgg_view('input/radio',array('internalname'=>'params[remove_css_class]','options'=>$options, 'value'=>$value));
		?>
	</div>
